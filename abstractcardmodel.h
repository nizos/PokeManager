...
class AbstractCardModel : public QAbstractListModel
{
    Q_OBJECT
public:
    enum AlbumRoles { CardIDRole = Qt::UserRole + 1, AlbumMIDRole, CardMIDRole, CardNameRole, ImageURLRole, SubtypeRole, SupertypeRole, NumberRole, ArtistRole, RarityRole, SeriesRole, SetNameRole,  SetCodeRole, ConditionRole, StatusRole, LoadedRole};
